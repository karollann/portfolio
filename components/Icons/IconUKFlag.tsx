...
export const IconUKFlag = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    />
    <path
      d="M512 229.518H282.483V88.276h-52.966v141.242H0v52.965h229.517v141.242h52.966V282.483H512z"
      style={{
        fill: "#ff4b55",
      }}
    />
    <path
      d="M178.948 300.138.25 416.135c.625 4.263 4.14 7.59 8.577 7.59h12.159l190.39-123.586h-32.428v-.001zM346.388 300.138H313.96l190.113 123.404c4.431-.472 7.928-4.09 7.928-8.646v-7.258l-165.613-107.5zM0 106.849l161.779 105.014h32.428L5.143 89.137C2.123 90.54 0 93.555 0 97.104v9.745zM332.566 211.863 511.693 95.586c-.744-4.122-4.184-7.309-8.521-7.309h-12.647L300.138 211.863h32.428z"
      style={{
        fill: "#ff4b55",
      }}
    />
