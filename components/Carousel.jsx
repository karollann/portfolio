...
import natoursPhoto from "../projects_photos/natours.png";
import nexterPhoto from "../projects_photos/nexter.png";
import trilloPhoto from "../projects_photos/trillo.png";
import bankistPhoto from "../projects_photos/bankist.png";
import dadJokesPhoto from "../projects_photos/dadJokes.png";
import forkifyPhoto from "../projects_photos/forkify.png";
import yahtzeePhoto from "../projects_photos/yahtzee.png";
import todoListPhoto from "../projects_photos/todoList.png";
import colorPalettePhoto from "../projects_photos/colorPalette.png";
...
export const Slider = () => {
  ...
  return (
    <Carousel
      className={`${carouselStyles["carousel-container"]}`}
      swipeable={true}
      draggable={true}
      showDots={false}
...
{
  /* <div className={`${carouselStyles["carousel__img-container"]}`}>
        <Image
          src={natoursPhoto}
          alt="Natours Project Photo"
      ...
      <div className={`${carouselStyles["carousel__img-container"]}`}>
        ...
        <h3 className={`${carouselStyles["carousel__img-description"]}`}>
          HTML - CSS - Flexbox - Sass
        </h3>
      </div>
      <div className={`${carouselStyles["carousel__img-container"]}`}>
        <Image
          src={nexterPhoto}
          alt="Nexter Project Photo"
          className={carouselStyles.carousel__img}
        />
        <h2 className={`${carouselStyles["carousel__img-title"]}`}>
          Nexter Project
      ...
      <div className={`${carouselStyles["carousel__img-container"]}`}>
        <Image
          src={colorPalettePhoto}
          alt="Colors Palette Project Photo"
          className={carouselStyles.carousel__img}
        />
        <h2 className={`${carouselStyles["carousel__img-title"]}`}>
